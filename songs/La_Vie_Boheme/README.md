...
While the song itself is cheerful and energetic, many listeners will recognize it and know that the musical as a whole is darker.

In the original, there are dialogue segments interspersed with the music.  The lyrics as presented here remove those in a way that probably works.  I've also modified the opening to reference solstice instead of the in-plot funeral.
